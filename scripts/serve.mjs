...
http.createServer(async(req,res)=>{try{
 ...
 if(!target.startsWith(root)||relative.split('/').some(s=>s.startsWith('.'))||!(/^(src|reference|docs|assets)\//.test(relative)||['index.html','styles.css','LICENSE','NOTICE.md','version.json'].includes(relative))){res.writeHead(404).end();return;}
